function showAround(me) {
    var map = "map = new google.maps.Map(document.getElementById('bigMap'), {center: " + me + ", zoom: 15});";
    ...
    notes.forEach(function(note) {
        ...
        var mrk = "var mrk" + i + " = new google.maps.Marker({ position: " + loc + ", map: map, icon: '/icons/" + note.colorScheme + ".png', title: '" + note.title + "'});"
